# Power BI — Version 2 (in progress)

**Status: in progress.** This folder will hold Power BI dashboards that present the **six Version 1 business questions**.

There is no `.pbix` or Power BI project file here yet.

Intended sources for those dashboards are the Version 1 semantic views on `EnterpriseData_DW`:
...
When a report file is added, it belongs in this folder. Do not invent a dashboard file to fill the structure.
